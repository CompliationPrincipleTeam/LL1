...
public class Grammar {
    ...
    public ArrayList<String> strGrammer;
    ...
    public Grammar() {
        ...
        strGrammer = new ArrayList<String>();
    ...
    public void addProduction(String left, String right, boolean addTostr) {

        if (addTostr) {
            strGrammer.add(left + "->" + right);
        }
